        ...
        <div className=" ">
          <div className="flex flex-col md:flex-row justify-evenly items-center">
            <div className="w-4/5 md:w-1/3">
              <h2 className="text-6xl mb-5 font-semibold text-blue-600">
                {product?.name}
              </h2>
              ...
              <p >
                ...
                recusandae veritatis quam ea natus blanditiis numquam saepe
                labore, aliquam, a obcaecati quo ducimus doloremque modi vel
                tempora? Nulla, maxime harum?
              </p>
